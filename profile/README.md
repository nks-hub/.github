...
[![Web](https://img.shields.io/badge/web-nks--hub.cz-blue)](https://nks-hub.cz)
[![Email](https://img.shields.io/badge/email-dev%40nks--hub.cz-green)](mailto:dev@nks-hub.cz)
[![Location](https://img.shields.io/badge/location-Czech%20Republic-red)](#)
[![License](https://img.shields.io/badge/license-MIT-brightgreen)](#)

Open-source balíčky a rozšíření pro **Nette Framework**, TypeScript SDK a nástroje.

### Nette Extensions

| Balíček | Popis | Lang | PHP |
|---------|-------|------|-----|
| [![nette-cloudflare-r2](https://img.shields.io/packagist/v/nks-hub/nette-cloudflare-r2?label=nette-cloudflare-r2)](https://github.com/nks-hub/nette-cloudflare-r2) | Cloudflare R2 storage — S3 upload/download, multipart, presigned URLs, Tracy panel | ![PHP](https://img.shields.io/badge/-PHP-777BB4?logo=php&logoColor=white&style=flat-square) | 7.4+ |
| [![nette-ares](https://img.shields.io/packagist/v/nks-hub/nette-ares?label=nette-ares)](https://github.com/nks-hub/nette-ares) | ARES API — vyhledání firmy podle IČO/názvu, cachování výsledků | ![PHP](https://img.shields.io/badge/-PHP-777BB4?logo=php&logoColor=white&style=flat-square) | 8.1+ |
...
| Projekt | Popis | Lang | Platformy |
|---------|-------|------|-----------|
| [![rybbit-app](https://img.shields.io/github/v/release/nks-hub/rybbit-app?label=rybbit-app&include_prereleases)](https://github.com/nks-hub/rybbit-app) | Flutter mobilní klient pro [Rybbit](https://github.com/rybbit-io/rybbit) analytics — dashboard, sessions, events, Core Web Vitals | ![Flutter](https://img.shields.io/badge/-Flutter-02569B?logo=flutter&logoColor=white&style=flat-square) | Android, iOS |

### Instalace

```bash
# Nette extensions (Composer)
...
- **Web**: [nks-hub.cz](https://nks-hub.cz)
- **Email**: [dev@nks-hub.cz](mailto:dev@nks-hub.cz)
- **GitHub**: [github.com/nks-hub](https://github.com/nks-hub)
